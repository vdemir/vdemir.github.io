...
** ```#define yalnızca değerler için takma ad tanımlamak için kullanılabilirken typedef veri tiplerine sembolik adlar vermekle sınırlıdır.```
...
1.  Başka yollarla ilan edilmiş olabilecek data tipleri için eşdeğerlerini tanıtmamızı sağlar.
