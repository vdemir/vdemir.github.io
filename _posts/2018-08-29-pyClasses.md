...
<ul>
  <li id="main_menu"><textarea autocomplete="off" id="textareaCode" wrap="logical" rows="7" cols="30" spellcheck="false">
class ClassName:
    'class docstring'
  ...
  <li><textarea autocomplete="off" id="textareaCode" wrap="logical" rows="30" cols="30" spellcheck="false">
