...
| `long`   |  Daha büyük değerler tutabilen tamsayı | `long evrenin_yaşı = 13798000000;`
...
Bir işlevi tanımlamak için, döndürdüğü değişkenin türünü, işlevin adını ve ardından parantez içinde virgülle ayrılmış girdi olarak alınan değişkenlerin bir listesini yazarız. İşlevin içeriği kaşlı ayraç {} içine konur ve işlevi yürütülen ve noktalı virgüllerle sonlandırılan tüm ifadeleri listelenir. Bir `return` deyimi, işlevin bitmesini ve bir değişken çıktılamasını sağlamak için kullanılır.
