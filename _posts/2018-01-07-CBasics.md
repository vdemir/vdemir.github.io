...
|  Type    |  Description
|----------|-------------------------------------------------------
| `void`   |  Boş, içeriksiz Tip
| `char`   |  Tek Karakter/Byte	                    | `char last_initial = 'H';`
| `int`	   |  Tamsayı			            | `int age = 23;`
| `long`   |  Daha büyük değerler tutabilen tamsayı | `long age_of_universe = 13798000000;`
| `float`  |  Ondalık Sayı		            | `float liters_per_pint = 0.568f;`
| `double` |  Daha kesin olan ondalık sayı          | `double speed_of_swallow = 0.01072896;`	
