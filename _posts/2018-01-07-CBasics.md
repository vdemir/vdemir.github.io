...
Diğer kütüphanelerdeki[libraries] işlevleri[functions] çağırmak veya onların veri türlerini[data types] kullanmak mümkündür. Bu, karmaşıklığın katmanlarının C programlamasında nasıl biriktirildiğidir.
