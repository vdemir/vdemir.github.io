...
A command to create a user for clamav         : 
...
~~~
sudo mkdir /var/log/clamav /var/lib/clamav /var/run/clamav /etc/clamav/freshclam.conf
~~~

~~~
chown -R clamav:clamav /var/log/clamav /var/lib/clamav /var/run/clamav /etc/clamav/freshclam.conf
~~~
