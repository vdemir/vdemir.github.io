...
[root@ system]# systemctl enable clamd.service
[root@ system]# systemctl enable clamd@scan.service
[root@ system]# systemctl start clamd.service
[root@ system]# systemctl start clamd@scan.service
