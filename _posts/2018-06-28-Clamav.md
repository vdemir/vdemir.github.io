...
Linux has experienced only a small number of viruses. Some of these viruses still exist but aren't active, and they certainly don't propagate. As Linux on the desktop reaches critical mass, there's a possibility that more viruses will appear, but that may still be a long ways off. 
...
# chmod 644 /var/log/clamav/freshclam.log /var/log/clamav/clamd.log
# chown clamav /var/log/clamav/freshclam.log /var/log/clamav/clamd.log
~~~
