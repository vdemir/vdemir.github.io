...
<div id="container">
      <div id="textareawrapper">
        <textarea autocomplete="off" id="textareaCode" wrap="logical" rows="150" cols="100" spellcheck="false">
class Person:
...
Nesnelerin özelliklerini del anahtar sözcüğünü kullanarak silebilirsiniz:
