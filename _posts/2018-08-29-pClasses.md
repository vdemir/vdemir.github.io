...
Nesnenin özniteliklerine, yalnızca nokta (.) Operatörünü nesne ile kullanarak erişebilirsiniz. Sınıf değişkenini kullanarak sınıf değişkenine erişilebilir:
<div class="w3-code notranslate pythonHigh">
  print(p1.x)</div><br><br>
