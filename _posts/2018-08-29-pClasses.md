...
<h3>Örnek Nesneleri Oluşturma</h3><hr>
 Bir sınıfın bir örneğini oluşturmak için, sadece sınıf adını kullanarak sınıfı çağırır ve daha sonra _init_ yönteminin kabul ettiği argümanları iletirsiniz:
<div class="w3-code notranslate pythonHigh">
