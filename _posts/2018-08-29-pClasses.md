...
<h3>Örnek Object Oluşturma</h3><hr>
...
<div class="teaser clearfix"></div>
<h3>Erişim Öznitelikleri</h3><hr>
Nesnenin özniteliklerine, yalnızca nokta (.) operatörünü nesne ile kullanarak erişebilirsiniz. Sınıf adı kullanarak sınıf değişkenine erişilebilir:
<div class="w3-code notranslate pythonHigh">
  print(p1.x)<br>print("variable x = %d" % MyClass.x)</div><br><br>
...
<div class="w3-code notranslate pythonHigh">
  class MyClass:<br>&nbsp; x = 5<br>p1 = MyClass()<br>print(p1.x)<br>print("variable x = %d" % MyClass.x)</div>
