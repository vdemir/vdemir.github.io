...
Burada, (class docstring) class_name._doc_ üzerinden erişilebilen bir belge dizesivardır ve class_suite temel olarak sınıf üyelerini, veri niteliklerini ve işlevlerini tanımlayan tüm bileşen ifadelerinden oluşur.

<div id="container">
        <textarea autocomplete="off" id="textareaCode" wrap="logical" rows="5" cols="35" spellcheck="false">
class ClassName:
    'class docstring'
