...
<h3>self Parametre</h3><hr>
<p> self parametresi, sınıfa kendisi için bir referanstır ve sınıfa ait değişkenlere erişmek için kullanılır. 

self diye isim almak zorunda değil, ne istersen onu arayabilirsin, ama sınıftaki herhangi bir işlevin ilk parametresi olmalı:</p>
