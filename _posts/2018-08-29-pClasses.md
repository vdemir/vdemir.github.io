  ...
  <div id="textareacontainer">
    <div id="textarea">
      <div id="textareawrapper">
        <div style="position:absolute;text-align:center;z-index:4;width:100%;"><span style="opacity:0.9;padding:1px 6px;font-family:Consolas;background-color:#f1f1f1;font-size:16px;">demo_class6.py:</span></div>
  ...
  <div id="iframecontainer">
    <div id="iframe">
      <div id="iframewrapper">
        <div id="iframeResult" style="white-space:nowrap;overflow:auto;">C:\Users\My Name>python demo_class6.py<br>40
</div>
      </div>
    </div>
  </div>
