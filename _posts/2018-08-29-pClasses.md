...
<br><a class="w3-btn w3-margin-bottom">Örnek Kod Çalıştırın &raquo;</a>
<div data-type="Python 2">Just python 2 'Run'.</div>
<br>
<div class="teaser clearfix"></div>
...
<div data-type="Python 2">Just python 3 'Run'.</div>
