...
<br><a target="_blank" class="w3-btn w3-margin-bottom">Örnek Kod Çalıştırın &raquo;</a>
<br>
<div class="teaser clearfix"></div>
...
<div id="container">
        <textarea autocomplete="off" id="textareaCode" wrap="logical" rows="13" cols="40" spellcheck="false">
class Person:
