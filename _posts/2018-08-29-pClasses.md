...
Burada, class_name._doc_ üzerinden erişilebilen bir belge dizesi (class docstring) vardır ve class_suite temel olarak sınıf üyelerini, veri niteliklerini ve işlevlerini tanımlayan tüm bileşen ifadelerinden oluşur.
...
<h3>Object Örneğini Oluşturma</h3><hr>
...
<div class="w3-note">
  <p><strong>Not:</strong> <code class="w3-codespan">__init__()</code> bir sınıfın kurucusudur. <code class="w3-codespan"> __init__()</code> yöntemi, nesnenin belleğinin tahsis edildiği anda çağrılır.</p>
</div> 
<div class="w3-note">
...
<a>Python 3 paket listesine bakınız: documents.datacamp.com/default_python_packages.txt</a>
