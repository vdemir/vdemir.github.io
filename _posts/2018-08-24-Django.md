...
<pre><code data-language='bash'>-v /var/cache/pisi/packages:/var/cache/pisi/packages</code></pre> 
<pre><code data-language='bash'>-itd --security-opt=seccomp:unconfined ertugerata/pisi-chroot-beta bash</code></pre>
<hr>
